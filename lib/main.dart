...
import 'story_brain.dart'; // Step 9a
...
//Step 9b - Create a new storyBrain object from the StoryBrain class.
...
class _StoryPageState extends State<StoryPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        //STEP 1 - added background image - completed
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Expanded(
                flex: 2,
                child: FlatButton(
                  //Step 24 - wrap getStory() in setState()
                  onPressed: () {
